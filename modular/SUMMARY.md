...
Updated 2026-09-14 14:28 UTC by GitHub Actions. It reads the current code of 47 Ventusltd repositories.
...
| | count |
|---|---|
| Unique lines | 249,018 |
| File versions | 5,506 |
| Elements (functions and classes) | 16,945 |
| Families (same logic) | 15,601 |
