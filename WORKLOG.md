...
- 2026-09-14 12:19 — Public wording made plain business English: the Vedic star is now the Classification star with five named classes (Structure, Movement, Computation, Flow, Data), its report is `reports/CLASSIFICATION.md`, on the dashboard and the website. GitHub write-ups keep their own voice. Graph ids are unchanged, so the dashboard updates the title on its next hourly check.
